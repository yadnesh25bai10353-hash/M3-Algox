    ...
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
        <div
          ...
          onClick={onClose}
        />
        <div className="w-full max-w-lg relative z-10 bg-navy-800 rounded-2xl border border-navy-600 shadow-2xl overflow-hidden">
          {/* Header */}
          <div className="p-6 border-b border-navy-700/80 flex justify-between items-center bg-red-950/20">
          ...
          <div className="p-6 space-y-4">
            <div className="bg-navy-900 border border-red-900/30 rounded-xl p-5 space-y-4">
        ...
        <div className="p-6 border-t border-navy-700/80 bg-navy-800/90 backdrop-blur-md flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          {requestSuccess ? (
            ...
            <button
              ...
              className={`flex-shrink-0 font-bold py-3 px-8 rounded-lg transition-all duration-200 active:scale-[0.97] shadow-lg flex items-center gap-2 ${
