      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex space-x-8">
            <Link to="/#bots" className="text-gray-300 hover:text-white transition-colors duration-200">Bots</Link>
            <Link to="/#pricing" className="text-gray-300 hover:text-white transition-colors duration-200">Pricing</Link>
            <a href="https://wa.me/917721921093?text=Hi%2C%20I%20need%20support%20for%20Yadnesh%20AI%20bot." target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-green-400 transition-colors duration-200 flex items-center gap-1">
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-[#111827] border-b border-[#1a2234]">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <Link to="/#bots" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-[#1a2234]" onClick={() => setIsMobileMenuOpen(false)}>Bots</Link>
            <Link to="/#pricing" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-[#1a2234]" onClick={() => setIsMobileMenuOpen(false)}>Pricing</Link>
            <a href="https://wa.me/917721921093?text=Hi%2C%20I%20need%20support%20for%20Yadnesh%20AI%20bot." target="_blank" rel="noopener noreferrer" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-green-400 hover:bg-[#1a2234]" onClick={() => setIsMobileMenuOpen(false)}>💬 WhatsApp Support</a>
