  ...
  return (
    <section className="relative w-full overflow-hidden bg-navy-900 border-b border-navy-700">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 text-center">
        {/* Headings */}
        <div className="inline-block mb-4 px-3 py-1 rounded-full border border-accent/30 bg-accent/5 backdrop-blur-md">
          <span className="text-accent-light text-xs font-bold uppercase tracking-widest">Premium Algorithmic Trading</span>
        </div>
        <h1 className="font-heading text-4xl md:text-5xl lg:text-7xl font-extrabold text-white leading-tight mb-6 tracking-tight">
          Automate Your Trading with <br className="hidden md:block" />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent-light via-accent to-accent-gold drop-shadow-sm">AI-Powered Bots</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
          <a 
            ...
            className="w-full sm:w-auto btn-primary text-lg px-10 py-4"
          >
            Get M3 Algo
          </a>
          <Link 
            to="/how-it-works" 
            className="w-full sm:w-auto btn-secondary text-lg px-10 py-4"
          >
            How It Works
          </Link>
        </div>
